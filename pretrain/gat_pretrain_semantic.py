...
from old_codes.gat import GAT_PRETRAIN
...
def main(args):
    ...
    save_root = 'pretrain/results/' + dataset_name + '_gat_pretrain_semantic/'
    if not os.path.exists(save_root):
        os.makedirs(save_root)
    

    pretrain_data_root = '/workspace1/zty/pretrain_data/gat_pretrain_semantic/'
    ...
    for cross_id in range(args.cross_num):
        ...
        feat_pretrained_path = feat_save_root + dataset_name + '_semantic_gat_pretrained_lr' + str(args.lr) + 'r' + str(args.loss_eta2) + '_' + str(cross_id)  +  '.pkl'
        ...
        model = GAT_PRETRAIN(args, g, num_feats, hidden_dim , args.pretrain_dim, num_heads, loss_fcn, loss_1_fcn,loss_2_fcn, train_important_idx, train_normal_idx , imp_bin_idx2node_idx, imp_node_idx2bin_idx, imp_node_coeff)
        ...
        print()
        print('gat_features_pretrained.shape:',features_pretrained.shape)     
