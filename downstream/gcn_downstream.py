...
from baseline_models.gcn import GCN
...
def main(args):
    ...
    # set the save path
    save_root = 'pretrain/results/' + args.dataset + '_' + args.pretrain_model +  '_pretrain_gcn/'
    ...
    for cross_id in range(args.cross_num):
        ...
        model = GCN(in_dim=num_feats, hidden_dim=64, out_dim=1)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='PreGAT-Pretrain-GCN')
