...
def main(args):
    ...
    for cross_id in range(args.cross_num):
        ...
        feat_pretrained_path = feat_save_root + dataset_name + '_semantic_pregat_pretrained_lr' + str(args.lr) + 'l1' + str(args.loss_eta1) + 'l2' + str(args.loss_eta2) + '_' + str(cross_id) + '.pkl'
    ...
    print('---------------------')
    print('important_ratio | pretrain-patience | lr')
    print('{} | {} | {}'.format(args.important_ratio, args.pretrain_patience, args.lr))
    print('---------------------')
    print('pretrain | epoch | patience')
    print('{} | {} | {}'.format(args.pretrain_model, args.epochs, args.patience))
    print('---------------------')
    print('l1 | l2')
    print('{} | {}'.format( args.loss_eta1,  args.loss_eta2))
    print('---------------------')
